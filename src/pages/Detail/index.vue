        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl
                v-for="(attrList, index) in spuSaleAttrList"
                :key="attrList.id"
              >
                ...
                <dd
                  ...
                  v-for="(
                    attrValueList, index
                  ) in attrList.spuSaleAttrValueList"
                  :key="attrValueList.id"
                  :class="{ active: attrValueList.isChecked == 1 }"
                  @click="
                    changeActive(attrValueList, attrList.spuSaleAttrValueList)
                  "
                >
